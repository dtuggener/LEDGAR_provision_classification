...
if __name__ == '__main__':
    ...
    # TODO use vanilla fasttext embeddings and OOV work prediction
    ...
    train_x_int = [[vocab[w] for w in re.findall('\w+', x_) if w in vocab]
                   for x_ in dataset.x_train]
    test_x_int = [[vocab[w] for w in re.findall('\w+', x_) if w in vocab]
                  for x_ in dataset.x_test]
    dev_x_int = [[vocab[w] for w in re.findall('\w+', x_) if w in vocab]
